...
const LiveMatchesCard = ({ IMAGESOURCE, TITLE, VIEWS, DATE }) => {
    return (
        ...
        >
            ...
            <TouchableOpacity className="z-50 absolute mt-32 pt-3 flex flex-row justify-center items-center">
                <View className="bg-redColor flex flex-row justify-center items-center rounded-full p-1 pl-3 pr-3">
                    <Icon name='play-circle' size={25} color={'#ffffff'} />
                    <Text className="text-white font-extrabold pl-1"> Live</Text>
                </View>
            </TouchableOpacity>
